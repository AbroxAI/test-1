// ultimate-realism-full-v9.2-merged.js — Full Human-Like Multi-Turn Realism Engine (WITH IMAGE SUPPORT)
(function(){
'use strict';
...
/* =====================================================
COMMENT GENERATOR WITH IMAGE META
===================================================== */
...
function pickRandomImage(){
  const imageCount = 50; // adjustable, auto-expands if you add more images
  const index = 1 + Math.floor(Math.random()*imageCount);
...
function generateComment(persona,lastTimestamp=new Date()){
  ...
  // add random image meta for testimonials
  if(Math.random()<0.45){ meta.image = pickRandomImage(); }
...
console.log("✅ Ultimate Realism Engine FULL PATCHED + FULL TEMPLATES + IMAGE SUPPORT — MERGED joiners, smooth");
})();
