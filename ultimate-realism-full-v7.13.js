(function(){
  ...
  function autoSimulate(lastTimestamp = new Date()) {
    ...
    // Repeat simulation every 5-10 seconds
    const nextTimestamp = generateTimestamp(randomComment.timestamp);
    setTimeout(() => autoSimulate(nextTimestamp), randomDelay(5000, 10000));
  }
